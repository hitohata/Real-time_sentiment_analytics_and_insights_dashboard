...
const suggestionsParameters = z.object({
    from: z.string().datetime({
        ...
        description: "The start date for the suggestions data. This should be in ISO 8601 format.",
        example: "1970-01-01T00:00:00.000Z",
    }),
    to: z.string().datetime({
        message: "Invalid date format. Expected ISO 8601 format.",
    }).optional().openapi({
        description: "The end date for the suggestions data. This should be in ISO 8601 format.",
        example: "1970-01-01T00:00:00.000Z",
    })
});
...
const route = createRoute({
    ...
    path: "/",
    request: {
        params: suggestionsParameters
    },
    responses: {
        200: {
            description: "The suggestions for the dashboard users. These suggestions are generated by the AI model. So, it can be long time to get the suggestions.",
            content: {
                "application/json": {
