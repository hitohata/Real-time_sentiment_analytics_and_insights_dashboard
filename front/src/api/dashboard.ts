 ...
 */
export type PostFeedbacksBodyFeedbackSource =
	(typeof PostFeedbacksBodyFeedbackSource)[keyof typeof PostFeedbacksBodyFeedbackSource];
...
export type GetAnalysisSummaries200SummariesItemFeedbackSource =
	(typeof GetAnalysisSummaries200SummariesItemFeedbackSource)[keyof typeof GetAnalysisSummaries200SummariesItemFeedbackSource];
...
export type GetAnalysisSummaries200SummariesItemStatementLabel =
	(typeof GetAnalysisSummaries200SummariesItemStatementLabel)[keyof typeof GetAnalysisSummaries200SummariesItemStatementLabel];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetAnalysisSummaries200SummariesItemStatementLabel = {
	positive: "positive",
	negative: "negative",
	neutral: "neutral",
} as const;
...
export type GetAnalysisSummaries200SummariesItem = {
	...
	feedback: string;
	statementLabel: GetAnalysisSummaries200SummariesItemStatementLabel;
	/**
...
export type GetAnalysisSummaries500 = {
	message: string;
};
...
export type postFeedbacksResponseComposite =
	| postFeedbacksResponse202
	| postFeedbacksResponse400;
...
export const postFeedbacks = async (
	postFeedbacksBody: PostFeedbacksBody,
	options?: RequestInit,
): Promise<postFeedbacksResponse> => {
	return customFetch<postFeedbacksResponse>(getPostFeedbacksUrl(), {
		...options,
		method: "POST",
		headers: { "Content-Type": "application/json", ...options?.headers },
		body: JSON.stringify(postFeedbacksBody),
	});
};
...
export type getSuggestionsResponse500 = {
	data: GetSuggestions500;
	status: 500;
};

export type getSuggestionsResponseComposite =
	| getSuggestionsResponse200
	| getSuggestionsResponse400
...
export type getAnalysisSummariesResponse500 = {
	data: GetAnalysisSummaries500;
	status: 500;
};

export type getAnalysisSummariesResponseComposite =
	| getAnalysisSummariesResponse200
	| getAnalysisSummariesResponse400
	| getAnalysisSummariesResponse500;

export type getAnalysisSummariesResponse =
	getAnalysisSummariesResponseComposite & {
		headers: Headers;
	};

export const getGetAnalysisSummariesUrl = (
	params?: GetAnalysisSummariesParams,
) => {
	const normalizedParams = new URLSearchParams();
	...
	return stringifiedParams.length > 0
		? `/analysis-summaries?${stringifiedParams}`
		: `/analysis-summaries`;
};

export const getAnalysisSummaries = async (
	params?: GetAnalysisSummariesParams,
	options?: RequestInit,
): Promise<getAnalysisSummariesResponse> => {
	return customFetch<getAnalysisSummariesResponse>(
		getGetAnalysisSummariesUrl(params),
		{
			...options,
			method: "GET",
		},
